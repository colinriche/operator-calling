    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
      <AnimatedSection className="mb-12">
        ...
        {/* Both buttons lead to the waitlist until there is a store listing to
            send people to. They kept the stores' own wording while they pointed
            at nothing, which promised a download that did not exist. */}
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          >
            ...
            <div className="text-left">
              <div className="text-xs opacity-70">Coming to the</div>
          ...
          >
            ...
            <div className="text-left">
              <div className="text-xs opacity-70">Coming to</div>
      ...
      <AnimatedSection delay={0.2}>
        <p className="text-sm text-muted-foreground mb-3">
          Either button takes you to the waitlist.
        </p>
